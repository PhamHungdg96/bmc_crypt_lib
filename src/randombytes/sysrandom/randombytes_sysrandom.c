...
static SysRandom stream = {
    ...
    BMC_CRYPT_C99(.getrandom_available =) 0
};
...
struct randombytes_implementation randombytes_sysrandom_implementation = {
    BMC_CRYPT_C99(.implementation_name =) randombytes_sysrandom_implementation_name,
    BMC_CRYPT_C99(.random =) randombytes_sysrandom,
    BMC_CRYPT_C99(.stir =) randombytes_sysrandom_stir,
    BMC_CRYPT_C99(.uniform =) NULL,
    BMC_CRYPT_C99(.buf =) randombytes_sysrandom_buf,
    BMC_CRYPT_C99(.close =) randombytes_sysrandom_close
};
