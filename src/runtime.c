...
static int
_bmc_crypt_runtime_arm_cpu_features(CPUFeatures * const cpu_features)
{
...
static int
_bmc_crypt_runtime_intel_cpu_features(CPUFeatures * const cpu_features)
{
...
int
bmc_crypt_runtime_has_neon(void)
{
    return _cpu_features.has_neon;
}

int
bmc_crypt_runtime_has_armcrypto(void)
{
    return _cpu_features.has_armcrypto;
}

int
bmc_crypt_runtime_has_sse2(void)
{
    return _cpu_features.has_sse2;
}

int
bmc_crypt_runtime_has_sse3(void)
{
    return _cpu_features.has_sse3;
}

int
bmc_crypt_runtime_has_ssse3(void)
{
    return _cpu_features.has_ssse3;
}

int
bmc_crypt_runtime_has_sse41(void)
{
    return _cpu_features.has_sse41;
}

int
bmc_crypt_runtime_has_avx(void)
{
    return _cpu_features.has_avx;
}

int
bmc_crypt_runtime_has_avx2(void)
{
    return _cpu_features.has_avx2;
}

int
bmc_crypt_runtime_has_avx512f(void)
{
    return _cpu_features.has_avx512f;
}

int
bmc_crypt_runtime_has_pclmul(void)
{
    return _cpu_features.has_pclmul;
}

int
bmc_crypt_runtime_has_aesni(void)
{
    return _cpu_features.has_aesni;
}

int
bmc_crypt_runtime_has_rdrand(void)
{
    return _cpu_features.has_rdrand;
}

int
bmc_crypt_runtime_is_little_endian(void)
{
    return _cpu_features.is_little_endian;
}
